    ...
    , function(e, r, n) {
        ...
        e.exports = function() {
            ...
            (n = [{
                ...
                value: function() {
                    (0,
                    i.activator)(this.canvas, this.webGL, this.colorFormats, this.programs, this.pointers)
                }
            }, {
                key: "deactivate",
                value: function() {}
                ...
                value: function(e, r) {
                    ...
                    function o() {
                        ...
                        n && (t.style.backgroundRepeat = n.repeat ? "repeat" : "no-repeat",
                        t.style.backgroundPosition = n.position ? n.position : "center",
    ...
    , function(e, r, n) {
        ...
        r.initWebGL = function() {
            ...
            var i = function() {
                ...
                a = r.getExtension("OES_texture_float_linear")) : (o = r.getExtension("OES_texture_half_float"),
                a = r.getExtension("OES_texture_half_float_linear"));
                var u = n ? r.HALF_FLOAT : o.HALF_FLOAT_OES;
                r.clearColor(0, 0, 0, 1),
                n ? (e = v(r.RGBA16F, r.RGBA, u),
                t = v(r.RG16F, r.RG, u),
                i = v(r.R16F, r.RED, u)) : (e = v(r.RGBA, r.RGBA, u),
                t = v(r.RGBA, r.RGBA, u),
                i = v(r.RGBA, r.RGBA, u));
                function v(e, n, t) {
            ...
            i.supportLinearFiltering || (t.behavior.render_shaders = !1,
            t.behavior.render_bloom = !1);
            var o = {
        ...
        r.activator = function(e, r, n, o, a) {
            ...
            v = !0;
            var m, c, s, d, g, p, b, h, S, y, R = t.behavior, T = [], E = [], x = (r.bindBuffer(r.ARRAY_BUFFER, r.createBuffer()),
            ...
            function D() {
                ...
                s = v.width,
                d = v.height,
                g = g ? A(g, s, d, t.internalFormat, t.format, e, a) : J(s, d, t.internalFormat, t.format, e, a),
                p = p ? A(p, m, c, i.internalFormat, i.format, e, a) : J(m, c, i.internalFormat, i.format, e, a),
            ...
            function _(e, n, t, i, o, a) {
                ...
                return r.bindFramebuffer(r.FRAMEBUFFER, v),
            ...
            function U(e) {
                ...
                r.texImage2D(r.TEXTURE_2D, 0, r.RGB, 1, 1, 0, r.RGB, r.UNSIGNED_BYTE, new Uint8Array([255, 255, 255]));
                var t = {
                    texture: n,
                    width: 1,
                    height: 1,
                ...
                i.onload = function() {
                    ...
                    t.height = i.height,
                    r.bindTexture(r.TEXTURE_2D, n),
                    r.texImage2D(r.TEXTURE_2D, 0, r.RGB, r.RGB, r.UNSIGNED_BYTE, i)
                }
                ,
                t
            }
            function w(n) {
                R.render_bloom && function(e, n) {
                    ...
                    var t = n;
                    r.disable(r.BLEND),
                    o.bloomPreFilterProgram.bind();
                    var i = R.threshold * R.soft_knee + 1e-4
                      , a = R.threshold - i
                      , u = 2 * i
                      , v = .25 / i;
                    r.uniform3f(o.bloomPreFilterProgram.uniforms.curve, a, u, v),
                    r.uniform1f(o.bloomPreFilterProgram.uniforms.threshold, R.threshold),
                    r.uniform1i(o.bloomPreFilterProgram.uniforms.uTexture, e.attach(0)),
                    r.viewport(0, 0, t.width, t.height),
                    x(t.fbo),
                    o.bloomBlurProgram.bind();
                    for (var l = 0; l < T.length; l++) {
                        var m = T[l];
                        r.uniform2f(o.bloomBlurProgram.uniforms.texelSize, 1 / t.width, 1 / t.height),
                        r.uniform1i(o.bloomBlurProgram.uniforms.uTexture, t.attach(0)),
                    ...
                    r.uniform2f(o.bloomFinalProgram.uniforms.texelSize, 1 / t.width, 1 / t.height),
                    r.uniform1i(o.bloomFinalProgram.uniforms.uTexture, t.attach(0)),
                    r.uniform1f(o.bloomFinalProgram.uniforms.intensity, R.intensity),
                    r.viewport(0, 0, n.width, n.height),
                    x(n.fbo)
                }(g.read, y),
                null != n && R.transparent ? r.disable(r.BLEND) : (r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA),
                r.enable(r.BLEND));
                var t = null == n ? r.drawingBufferWidth : s
                  , i = null == n ? r.drawingBufferHeight : d;
                if (r.viewport(0, 0, t, i),
                !R.transparent) {
                    o.colorProgram.bind();
                    var a = R.background_color;
                    r.uniform4f(o.colorProgram.uniforms.color, a.r / 255, a.g / 255, a.b / 255, 1),
                    x(n)
                }
                if (null == n && R.transparent && (o.backgroundProgram.bind(),
                r.uniform1f(o.backgroundProgram.uniforms.aspectRatio, e.width / e.height),
                x(null)),
                R.render_shaders) {
            ...
            function F(n, t, i, a, u) {
                ...
                r.uniform1f(o.splatProgram.uniforms.aspectRatio, e.width / e.height),
                r.uniform2f(o.splatProgram.uniforms.point, n / e.width, 1 - t / e.height),
            ...
            (function t() {
                ...
                !function() {
                    ...
                    for (var e = 0; e < a.length; e++) {
                        var r = a[e];
                        r.moved && (F(r.x, r.y, r.dx, r.dy, r.color),
                        1 !== e && (r.moved = !1))
                    }
                    if (!R.multi_color)
                        return;
                ...
                R.paused || function(e) {
                    ...
                    r.uniform1i(o.curlProgram.uniforms.uVelocity, p.read.attach(0)),
                    x(h.fbo),
                    o.vorticityProgram.bind(),
                    r.uniform2f(o.vorticityProgram.uniforms.texelSize, 1 / m, 1 / c),
                    r.uniform1i(o.vorticityProgram.uniforms.uVelocity, p.read.attach(0)),
                    ...
                    r.uniform2f(o.divergenceProgram.uniforms.texelSize, 1 / m, 1 / c),
                    r.uniform1i(o.divergenceProgram.uniforms.uVelocity, p.read.attach(0)),
                    x(b.fbo),
                    o.clearProgram.bind(),
                    r.uniform1i(o.clearProgram.uniforms.uTexture, S.read.attach(0)),
                    r.uniform1f(o.clearProgram.uniforms.value, R.pressure),
                    x(S.write.fbo),
                    S.swap(),
                    o.pressureProgram.bind(),
                    r.uniform2f(o.pressureProgram.uniforms.texelSize, 1 / m, 1 / c),
                    r.uniform1i(o.pressureProgram.uniforms.uDivergence, b.attach(0));
                    for (var t = 0; t < R.pressure_iteration; t++)
                        r.uniform1i(o.pressureProgram.uniforms.uPressure, S.read.attach(1)),
                        x(S.write.fbo),
                        S.swap();
                    o.gradientSubtractProgram.bind(),
                    r.uniform2f(o.gradientSubtractProgram.uniforms.texelSize, 1 / m, 1 / c),
                    r.uniform1i(o.gradientSubtractProgram.uniforms.uPressure, S.read.attach(0)),
                    r.uniform1i(o.gradientSubtractProgram.uniforms.uVelocity, p.read.attach(1)),
                    x(p.write.fbo),
                    p.swap(),
                    o.advectionProgram.bind(),
                    r.uniform2f(o.advectionProgram.uniforms.texelSize, 1 / m, 1 / c),
                    n.supportLinearFiltering || r.uniform2f(o.advectionProgram.uniforms.dyeTexelSize, 1 / m, 1 / c);
                    ...
                    r.uniform1f(o.advectionProgram.uniforms.dissipation, R.velocity),
                    x(p.write.fbo),
                    p.swap(),
                    r.viewport(0, 0, s, d),
                    n.supportLinearFiltering || r.uniform2f(o.advectionProgram.uniforms.dyeTexelSize, 1 / s, 1 / d);
                    r.uniform1i(o.advectionProgram.uniforms.uVelocity, p.read.attach(0)),
                    r.uniform1i(o.advectionProgram.uniforms.uSource, g.read.attach(1)),
                    r.uniform1f(o.advectionProgram.uniforms.dissipation, R.dissipation),
                    x(g.write.fbo),
                    g.swap()
                }(.016);
                w(null);
